...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'A modular CLI for financial and stock market analysis using the SQA gem. ' \
                       'Features include backtesting, pattern discovery, genetic programming, ' \
                       'portfolio optimization, and real-time market analysis.'
